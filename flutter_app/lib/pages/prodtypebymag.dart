...
import '../pages/prodsBySt.dart';
class ProdTypesbyMag extends StatefulWidget {
  final int id;
  ProdTypesbyMag({Key key, @required this.id}) : super(key: key);
  @override
  State<StatefulWidget> createState()=> new _ProdTypesbyMag(id: id);}
class _ProdTypesbyMag extends State<ProdTypesbyMag>{
  final int id;
  _ProdTypesbyMag({Key key, @required this.id});
  final String url =Routes.apiUrl+"getStBymag/";
  List data;
  Future<String> getSt(String id) async{
            ...
            itemBuilder: (BuildContext context, int index) {
              return new GestureDetector(
                  onTap: (){Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ProdBySt(id:data[index]["id"],idm: data[index]["idMag"], ),
                    ),
                  );},
                  child:
                  Padding(
