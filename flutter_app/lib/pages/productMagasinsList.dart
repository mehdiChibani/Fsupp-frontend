...
class ProductMagasinsList extends StatefulWidget {
  final int id;
  ProductMagasinsList({Key key, @required this.id}) : super(key: key);
  @override
  State<StatefulWidget> createState()=> new _ProductMagasinsList(id: id);}
class _ProductMagasinsList extends State<ProductMagasinsList>{
  final int id;
  _ProductMagasinsList({Key key, @required this.id});
  final String url =Routes.apiUrl+"prodmagasins/";
  List data;
